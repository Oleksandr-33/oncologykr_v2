...
This document outlines the content strategy for oncologykr, ensuring all content is accurate, accessible, trustworthy, and serves the needs of patients, families, and healthcare providers.

---

## Content Vision

**"Empowering patients and families with clear, accurate, and compassionate oncology information that helps them navigate their cancer journey with confidence."**
...
Specialties: [List of subspecialties]
...
Contact: [Phone, email if appropriate]
```
...
## Medical Information Accuracy Standards
...
│        ▼                                                        │
│   ┌───────────────┐                                             │
│   │ Content Team  │ ── Grammar, style, readability              │
│   │    Review     │                                             │
│   └───────┬───────┘                                             │
│           │                                                     │
│           ▼                                                     │
│   ┌───────────────┐                                             │
│   │   Medical     │ ── Accuracy, completeness, safety           │
│   │    Review     │    (Licensed oncologist required)           │
│   └───────┬───────┘                                             │
│           │                                                     │
│           ▼                                                     │
│   ┌───────────────┐                                             │
│   │    Legal/     │ ── Compliance, liability                    │
│   │  Compliance   │    (For sensitive content)                  │
│   └───────┬───────┘                                             │
│           │                                                     │
│           ▼                                                     │
│   ┌───────────────┐                                             │
│   │    Final      │ ── Medical director sign-off                │
│   │   Approval    │                                             │
│   └───────┬───────┘                                             │
│           │                                                     │
│           ▼                                                     │
...
### Medical Reviewer Responsibilities

1. Verify all medical facts against current guidelines
2. Check for outdated information
3. Ensure appropriate disclaimers present
4. Confirm no misleading claims
5. Validate treatment information accuracy
6. Review for patient safety concerns
7. Sign off with credentials displayed
...
Завжди консультуйтеся зі своїм лікарем щодо будь-яких питань
про ваш стан здоров'я.

---

This information is for educational purposes only and does not
replace professional medical advice, diagnosis, or treatment.
Always consult your doctor about any questions regarding your
health condition.
```
...
If you have concerning symptoms, contact your doctor immediately.
Do not delay seeking medical care.
```

### Sources and Citations

- Cite authoritative sources (national guidelines, major cancer organizations)
- Include publication dates for cited research
...
**Час читання:** X хвилин
**Останній перегляд:** [Дата]
...
- Business attire or medical coat
...
```
Structure:
1. Current role and department (1 sentence)
2. Specialization and expertise (1-2 sentences)
3. Experience highlights (1-2 sentences)
4. Education and training (1 sentence)
5. Professional approach (optional, 1 sentence)

Example:
Доктор Коваленко є провідним онкологом відділення хіміотерапії
з понад 15-річним досвідом лікування раку. Спеціалізується на
лікуванні раку молочної залози та раку легенів, з особливим
фокусом на персоналізованих схемах хіміотерапії. За свою
кар'єру провів понад 5000 курсів хіміотерапії. Закінчив
Дніпропетровську медичну академію та пройшов спеціалізацію
з онкології в Національному інституті раку.
```
...
- PDF format for downloadable documents
- Maximum 5MB per file
- Ukrainian language primary
- Clear filename conventions: `category-name-date.pdf`
- Accessible PDFs (tagged for screen readers)
- Print-optimized (standard paper sizes)
...
2. Content marked for review
3. Draft updates created
4. Medical review (if applicable)
5. Approval obtained
6. Content updated
7. "Last updated" date changed
8. Update logged
```
...
<h2>Що таке хіміотерапія?</h2>
<h3>Види хіміотерапії</h3>
```
...
3. **Lower Priority**
   ...
   - News (may remain Ukrainian only)
   - Administrative documents

### Translation Quality Standards

- Professional medical translator required
- Native speaker review
- Medical terminology verification
- Cultural adaptation (not just literal translation)
- Maintain tone and readability
...
[ ] All medical content reviewed by licensed oncologist
[ ] "Last updated" dates accurate
[ ] No broken links
[ ] All images have alt text
[ ] Contact information current
[ ] Doctor profiles current
[ ] Service packages match current offerings
[ ] FAQ reflects common recent inquiries
[ ] Documents downloadable and current
[ ] Disclaimers present on all medical content
...
[ ] Readability score acceptable (Grade 8)
[ ] Plain language used
